...
export default function Settings() {
  ...
  const [siteConfig, setSiteConfig] = useState({
    siteName: "Frances News",
    siteDescription: "Portal de notícias com as principais informações do Brasil e do mundo",
    siteUrl: "https://francesnews-lovable.lovable.app",
    contactEmail: "contato@francesnews.com",
    logo: "",
    favicon: "",
  });
