...
const Cultura = () => {
  const { data: category } = useCategoryBySlug('cultura');
  ...
  const transformArticleToNews = (article: any) => ({
    ...
    category: article.categories?.name || 'Cultura',
      ...
      <Layout>
        <div className="container mx-auto px-4 py-8">
          <Alert variant="destructive">
            <AlertDescription>
              Erro ao carregar as notícias de cultura. Tente novamente mais tarde.
            </AlertDescription>
          </Alert>
        </div>
      </Layout>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground">Nenhuma notícia de cultura disponível no momento.</p>
          </div>
        )}
