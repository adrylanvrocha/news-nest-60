...
const Politica = () => {
  const { data: category } = useCategoryBySlug('politica');
  ...
  const transformArticleToNews = (article: any) => ({
    ...
    category: article.categories?.name || 'Política',
      ...
      <Layout>
        <div className="container mx-auto px-4 py-8">
          <Alert variant="destructive">
            <AlertDescription>
              Erro ao carregar as notícias de política. Tente novamente mais tarde.
            </AlertDescription>
          </Alert>
        </div>
      </Layout>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground">Nenhuma notícia de política disponível no momento.</p>
          </div>
        )}
